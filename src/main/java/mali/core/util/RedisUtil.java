...
public class RedisUtil {
	 ...
	 * {@link DefaultCodec#encode(Serializable)}ed bytes of the parametric type
	 * <code>T</code>.
	 * <p>
	...
	public static final <T extends Serializable> List<T> decode(
			List<byte[]> byteList) {
	...
	@SuppressWarnings("unchecked")
	public static final <T extends Serializable> List<T> decode(
			List<byte[]> byteList, int offset, int size) {
	 ...
	 * {@link DefaultCodec#encode(Serializable)}, and it is assumed (and
	 ...
	 */
	public static final <T extends Serializable> byte[][] encode(
			Map<String, T> map) {
		if (map == null) {
			return null;
		}
